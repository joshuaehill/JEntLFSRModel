...
The LFSR used within JEnt v2.2.0 is linear, and thus can be modeled using matrix multiplication. This idea is explored in the paper [*JEnt v2.2.0 LFSR Conditioning Analysis*](https://www.untruth.org/~josh/sp80090b/jent-lfsr/JEnt%20v2.2.0%20LFSR%20Conditioning%20Analysis%20TRD20.pdf), which was presented in the CMUF Entropy Working Group using [this presentation](https://www.untruth.org/~josh/sp80090b/jent-lfsr/20260902%20JEnt%20v2.2.0%20LFSR%20Conditioning%20Analysis%20Slides.pdf).
