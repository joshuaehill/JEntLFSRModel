...
The `hprime-results.tar.xz` file contains the raw results associated with the distribution (cited in Section 4.2.2 in TRD13) is too large for GitHub, but can be found [here](https://untruth.org/~josh/sp80090b/jent-lfsr/hprime-results.tar.xz).
