...
The LFSR used within JEnt v2.2.0 is linear, and thus can be modeled using matrix multiplication. This idea is explored in the paper, which can be found <a href="https://www.untruth.org/~josh/sp80090b/jent-lfsr/">here</a>. This paper was presented in the CMUF Entropy Working Group using a presentation also available at that same site.
